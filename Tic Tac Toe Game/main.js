    ...
    for(let situation of winnerSituation){
        ...
        if(situation1 !== "" && situation2 !== "" && situation3 !== ""){
            if(situation1 === situation2 && situation2 === situation3){
                boxes[situation[0]].style.backgroundColor = "#F57D1F";
                boxes[situation[1]].style.backgroundColor = "#F57D1F";
                boxes[situation[2]].style.backgroundColor = "#F57D1F";
                setTimeout(() => {
...
const resetButton = () => {
    ...
    for(let box of boxes){
        ...
        box.style.backgroundColor = "#B67352";
    }
}
