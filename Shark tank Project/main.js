...
let allData = []
function showData(){
    fetch('http://localhost:3000/pitches').then((res)=>res.json()).then((data)=>{
        allData = data
        cardList(data)
...
function editProductData(id){
    fetch(`http://localhost:3000/pitches/${id}`).then((res)=>res.json()).then((data)=>{
...
function addToCart(id){
    fetch(`http://localhost:3000/pitches/${id}`).then((response)=>response.json()).then((datas)=>{
        fetch('http://localhost:3000/cartpage',{
          ...
          }).then((resp)=>resp.json()).then((addData)=>console.log(addData)).catch((err)=>console.log(err))
    }).catch((err)=>console.log(err))
}